...
export function DocSidebar() {
  ...
  const groups: { label: string; items: { href: string; key: string }[] }[] = [
    ...
    {
      label: t("groupModel"),
      items: [{ href: `/${locale}/docs/collaboration`, key: "collaboration" }],
    },
    {
      label: t("groupReference"),
      items: [{ href: `/${locale}/changelog`, key: "changelog" }],
    },
  ];
  ...
  return (
    <nav className="sticky top-0 h-screen w-[260px] shrink-0 overflow-auto border-r border-border bg-surface p-4">
      ...
      <div className="mb-7 px-2">
        <div className="font-mono text-base font-semibold text-text">agentwork</div>
